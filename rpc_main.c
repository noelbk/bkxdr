 ...
 */
char main_rcsid[] =
  "$Id: rpc_main.c,v 1.6 2007-12-29 09:04:53 noel Exp $";
...
static void s_output (int argc, char *argv[], char *infile,
		      char *define, int extend,
		      char *outfile, int nomain, int netflag);
static void l_output (char *infile, char *define,
		      int extend, char *outfile);
static void t_output (char *infile, char *define,
		      int extend, char *outfile);
static void svc_output (char *infile, char *define,
			int extend, char *outfile);
static void clnt_output (char *infile, char *define,
			 int extend, char *outfile);
static void mkfile_output (struct commandline *cmd);
static int do_registers (int argc, char *argv[]);
static void addarg (char *cp);
static void putarg (int whereto, char *cp);
...
open_input (char *infile, char *define)
{
  ...
  sprintf(buf, "cl -E %s %s", define, infile);
...
static void
c_output (char *infile, char *define, int extend,
	  char *outfile)
{
  definition *def;
  char *include;
...
static void
h_output (char *infile, char *define, int extend,
	  char *outfile)
{
  xdrfunc *xdrfuncp;
  definition *def;
 ...
 */
static void
s_output (int argc, char *argv[], char *infile, char *define,
 ...
 */
static void
l_output (char *infile, char *define, int extend,
	  char *outfile)
{
  char *include;
  definition *def;
 ...
 */
static void
t_output (char *infile, char *define, int extend,
	  char *outfile)
{
  definition *def;
  int foundprogram = 0;
...
static void
svc_output (char *infile, char *define, int extend,
	    char *outfile)
{
  definition *def;
  char *include;
...
static void
clnt_output (char *infile, char *define, int extend,
	     char *outfile)
{
  definition *def;
  char *include;
