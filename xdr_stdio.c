...
static bool_t xdrstdio_putbytes (XDR *, char *, u_int);
static u_int xdrstdio_getpos (XDR *);
static bool_t xdrstdio_setpos (XDR *, u_int);
static int32_t *xdrstdio_inline (XDR *, u_int);
static void xdrstdio_destroy (XDR *);
static bool_t xdrstdio_getint32 (XDR *, int32_t *);
static bool_t xdrstdio_putint32 (XDR *, int32_t *);
...
static bool_t
xdrstdio_putbytes (XDR *xdrs, char *addr, u_int len)
{
...
static bool_t
xdrstdio_putint32 (XDR *xdrs, int32_t *ip)
{
