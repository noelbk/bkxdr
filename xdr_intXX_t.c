...
xdr_int64_t (XDR *xdrs, int64_t *ip)
{
  ...
  uint32_t t2;
	...
	return xdrs->x_ops->x_type(xdrs, XDR_TYPE_INT64, ip, 0, 0, 0, 0);
    }
...
xdr_uint64_t (XDR *xdrs, uint64_t *uip)
{
  ...
  uint32_t t2;
    ...
    /* NBK - allow XDR treams like XML to format the standard types */
    if( xdrs->x_ops && xdrs->x_ops->x_type ) {
	return xdrs->x_ops->x_type(xdrs, XDR_TYPE_INT64, uip, 0, 0, 0, 0);
    }
...
xdr_int32_t (XDR *xdrs, int32_t *lp)
{
    ...
    /* NBK - allow XDR treams like XML to format the standard types */
    if( xdrs->x_ops && xdrs->x_ops->x_type ) {
	return xdrs->x_ops->x_type(xdrs, XDR_TYPE_INT32, lp, 0, 0, 0, 0);
    }
...
xdr_uint32_t (XDR *xdrs, uint32_t *ulp)
{
    ...
    /* NBK - allow XDR treams like XML to format the standard types */
    if( xdrs->x_ops && xdrs->x_ops->x_type ) {
	return xdrs->x_ops->x_type(xdrs, XDR_TYPE_UINT32, ulp, 0, 0, 0, 0);
    }
...
xdr_int16_t (XDR *xdrs, int16_t *ip)
{
  ...
  /* NBK - allow XDR treams like XML to format the standard types */
  if( xdrs->x_ops && xdrs->x_ops->x_type ) {
      return xdrs->x_ops->x_type(xdrs, XDR_TYPE_INT16, ip, 0, 0, 0, 0);
  }
...
xdr_uint16_t (XDR *xdrs, uint16_t *uip)
{
  ...
  /* NBK - allow XDR treams like XML to format the standard types */
  if( xdrs->x_ops && xdrs->x_ops->x_type ) {
      return xdrs->x_ops->x_type(xdrs, XDR_TYPE_UINT16, uip, 0, 0, 0, 0);
  }
...
xdr_int8_t (XDR *xdrs, int8_t *ip)
{
  ...
  /* NBK - allow XDR treams like XML to format the standard types */
  if( xdrs->x_ops && xdrs->x_ops->x_type ) {
      return xdrs->x_ops->x_type(xdrs, XDR_TYPE_INT8, ip, 0, 0, 0, 0);
  }
...
xdr_uint8_t (XDR *xdrs, uint8_t *uip)
{
  ...
  /* NBK - allow XDR treams like XML to format the standard types */
  if( xdrs->x_ops && xdrs->x_ops->x_type ) {
      return xdrs->x_ops->x_type(xdrs, XDR_TYPE_UINT8, uip, 0, 0, 0, 0);
  }
